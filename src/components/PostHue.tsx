  ...
  return (
    <div className='flex flex-row justify-evenly gap-6'>
        ...
        <div className='flex flex-col w-full p-4 gap-12'>
            <input className = "hueInput bg-slate-600 text-slate-400 rounded-full w-56 h-8 indent-1" type="text" name="hue" id="hue" onChange={ (event) => setColor(event.target.value) } value={color}/>
            <a href="#" onClick={ () => {
              props.addHue(color)  ;
              setColor("#");
            }
